...
public class ControlPanel extends JPanel
{
 ...
 /**
  * the juzzle panel that is the aprent of this component
  */
 protected JuzzlePanel jp;
 

 /**
  * simply constructor
  */
 public ControlPanel(JuzzlePanel jp)
  {
...
//  imagePanel_jsp.setPreferredSize(new Dimension(200, 200));
 ...
 public void sendEndNotification(int timeTaken, String pic, int numPiece) {
	 jp.endThisPuzzle(timeTaken, pic, numPiece);
 }
