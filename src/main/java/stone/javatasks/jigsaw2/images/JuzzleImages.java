...
package stone.javatasks.jigsaw2.images;
...
import stone.javatasks.jigsaw2.*;
...
public final class JuzzleImages
{
 ...
 public static Vector getImages()
  ...
  try
     ...
     // in the format
     // [image] [name]
     LineNumberReader lnr = new LineNumberReader(new InputStreamReader(thisClass.getResourceAsStream("/stimuli/imgs/jigsaw/puzzleImages.txt")));
     String line = null;
     String file = null;
     String name = null;
     int sep = -1;
...
//          System.out.println(file + ":" + name);
          ...
          ii = new ImageIcon(thisClass.getResource("/stimuli/imgs/jigsaw/" + file));
          iis = scaleIcon(ii, 80);
 ...
 public static ImageIcon getIcon(String name)
  {
  Class thisClass = JuzzleImages.class;
  return new ImageIcon(thisClass.getResource("/stimuli/imgs/jigsaw/" + name));
  }
}
