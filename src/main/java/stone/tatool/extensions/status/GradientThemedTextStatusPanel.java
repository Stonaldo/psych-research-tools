 ...
 *
 */
public class GradientThemedTextStatusPanel extends TextStatusPanel {

	private int theme = Theme.STANDARD_SILVER_THEME;
	private int panelType = PanelType.PANEL_RECTANGULAR;
	private BufferedImage panelImage;

	public GradientThemedTextStatusPanel() {
		setBorder(null);
	}
	 ...
	 *            label on the button
	 */
	public GradientThemedTextStatusPanel(int theme) {
		this.theme = theme;
		setBorder(null);
	}
	 ...
	 * @param buttonTheme
	 */
	public GradientThemedTextStatusPanel(int theme, int panelType) {
