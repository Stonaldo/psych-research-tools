...
import stone.javatasks.helperclasses.swing.util.Colors;
 ...
 * 
 */
public class CurvedGlossyThemedFeedbackStatusPanel extends CorrectWrongStatusPanel {
	 ...
	 * Default Constructor.
	 */
	public CurvedGlossyThemedFeedbackStatusPanel() {
		init();
	}
	 ...
	 *            text of the panel.
	 */
	public CurvedGlossyThemedFeedbackStatusPanel(String title) {
		this.title = title;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public CurvedGlossyThemedFeedbackStatusPanel(int theme) {
		this.theme = theme;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public CurvedGlossyThemedFeedbackStatusPanel(String title, int theme) {
		this.title = title;
		this.theme = theme;
		init();
	}
	 ...
	 *            text color
	 */
	public CurvedGlossyThemedFeedbackStatusPanel(String title, int theme, Color textColor) {
		this.title = title;
		this.theme = theme;
