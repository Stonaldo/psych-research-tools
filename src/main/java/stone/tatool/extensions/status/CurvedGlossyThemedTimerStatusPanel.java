...
public class CurvedGlossyThemedTimerStatusPanel extends TimerStatusPanel {
	 ...
	 * Default Constructor.
	 */
	public CurvedGlossyThemedTimerStatusPanel() {
		init();
	}
	 ...
	 *            text of the panel.
	 */
	public CurvedGlossyThemedTimerStatusPanel(String title) {
		this.title = title;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public CurvedGlossyThemedTimerStatusPanel(int theme) {
		this.theme = theme;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public CurvedGlossyThemedTimerStatusPanel(String title, int theme) {
		this.title = title;
		this.theme = theme;
		init();
	}
	 ...
	 *            text color
	 */
	public CurvedGlossyThemedTimerStatusPanel(String title, int theme, Color textColor) {
		this.title = title;
		this.theme = theme;
