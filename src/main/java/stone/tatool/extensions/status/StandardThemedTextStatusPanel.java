 ...
 * 
 */
public class StandardThemedTextStatusPanel extends TextStatusPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -155673513339142244L;
	private int theme;
	 ...
	 * Default Constructor.
	 */
	public StandardThemedTextStatusPanel() {
	 ...
	 *            label on the button
	 */
	public StandardThemedTextStatusPanel(int theme) {
		this.theme = theme;
		setBorder(null);
	}
	 ...
	 *            panel type
	 */
	public StandardThemedTextStatusPanel(int theme, int panelType) {
