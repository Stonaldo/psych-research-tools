 ...
 * 
 */
public class StandardGlossyThemedTextStatusPanel extends TextStatusPanel {
	...
	public StandardGlossyThemedTextStatusPanel() {
	 ...
	 *            theme of the panel
	 */
	public StandardGlossyThemedTextStatusPanel(int theme) {
		this.theme = theme;
		setBorder(null);
	}
	 ...
	 *            type of the panel
	 */
	public StandardGlossyThemedTextStatusPanel(int theme, int panelType) {
