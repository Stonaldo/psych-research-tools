 ...
 * 
 */
public class CurvedGlossyThemedTextStatusPanel extends TextStatusPanel {
	 ...
	 * Default Constructor.
	 */
	public CurvedGlossyThemedTextStatusPanel() {
		init();
	}
	 ...
	 *            text of the panel.
	 */
	public CurvedGlossyThemedTextStatusPanel(String title) {
		this.title = title;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public CurvedGlossyThemedTextStatusPanel(int theme) {
		this.theme = theme;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public CurvedGlossyThemedTextStatusPanel(String title, int theme) {
		this.title = title;
		this.theme = theme;
		init();
	}
	 ...
	 *            text color
	 */
	public CurvedGlossyThemedTextStatusPanel(String title, int theme, Color textColor) {
		this.title = title;
		this.theme = theme;
